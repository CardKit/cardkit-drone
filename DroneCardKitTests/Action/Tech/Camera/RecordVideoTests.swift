...
class RecordVideoTests: XCTestCase {
    ...
    func testRecordVideo() {
        ...
        waitForExpectations(timeout: 5) { error in
            ...
            XCTAssertTrue(cameraToken.calledFunctions.contains("recordVideo"), "recordVideo should have been called")
            XCTAssertTrue(cameraToken.calledFunctions.count == 1, "only one card should have been called")
